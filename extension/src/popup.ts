...
document.addEventListener("DOMContentLoaded", function () {
  ...
  chrome.tabs.query({ active: true, currentWindow: true }, function (tabs) {
    ...
    if (
      ...
      if (titlePage !== null) titlePage.style.display = "none";
      if (gamePage !== null) gamePage.style.display = "block";
      ...
      if (titlePage !== null) titlePage.style.display = "block";
      if (gamePage !== null) gamePage.style.display = "none";
    }
    loadDynamicCSS();
  });
});
