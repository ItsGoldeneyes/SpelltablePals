...
function main() {
  ...
  for (
    ...
    dropdown.addEventListener("click", () => {
      ...
      const player = (_h = (_g = (_f = (_e = (_d = (_c = (_b = (_a = dropdown
                                                        .parentElement) ===
                                                      null || _a === void 0
                                                  ? void 0
                                                  : _a.parentElement) ===
                                ...
                                ? void 0
                                : _d.querySelector("div.flex-1")) === null ||
                            _e === void 0
                          ? void 0
                          : _e.querySelector(
                    ...
                    ? void 0
                    : _f.querySelector("div.flex.items-center.w-full")) ===
                  null || _g === void 0
              ? void 0
              : _g.querySelector(
  ...
  nameElements.forEach((element) => {
    var _a;
    const name = (_a = element === null || element === void 0
            ? void 0
  ...
  commanderElements.forEach((element) => {
    ...
    if (!element.children) {
      ...
      if (element.children[0]) {
        child = (_b = (_a = element === null || element === void 0
                      ? void 0
                      : element.children[0]) === null || _a === void 0
                ? void 0
      ...
      if (element.children[2]) {
        child = (_d = (_c = element === null || element === void 0
                      ? void 0
                      : element.children[2]) === null || _c === void 0
                ? void 0
...
function formatNames() {
  ...
  elements.forEach((element) => {
    var _a;
    const elementText = (_a = element.textContent) === null || _a === void 0
      ? void 0
      : _a.trim().toLowerCase();
