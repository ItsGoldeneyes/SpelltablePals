...
document.addEventListener("DOMContentLoaded", function () {
    ...
    chrome.tabs.query({ active: true, currentWindow: true }, function (tabs) {
        ...
        if (url.hostname === "spelltable.wizards.com" &&
...
function getPlayersInfo() {
    ...
    const namesOnPage = Array.from(elements).map((element) => { var _a; return (_a = element.textContent) === null || _a === void 0 ? void 0 : _a.trim(); });
